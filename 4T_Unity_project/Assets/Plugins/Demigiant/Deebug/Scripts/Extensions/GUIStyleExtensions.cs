...
// Created: 2019/03/22 16:55 - Copy of DemiEditor's GUIStyleExtensions for runtime convenience
...
namespace DG.DeebugLib.Extensions
{
    ...
    internal static class GUIStyleExtensions
    {
        ...
        /// Sets the border of the style
        /// </summary>
        public static GUIStyle Border(this GUIStyle style, int value)
        {
            style.border = new RectOffset(value, value, value, value);
            return style;
        }
        ...
        /// </summary>
        public static GUIStyle Background(this GUIStyle style, Texture2D background, Texture2D hoverBackground = null, Texture2D pressBackground = null)
        {
            if (hoverBackground == null) hoverBackground = background;
            if (pressBackground == null) pressBackground = background;
            style.normal.background = style.onNormal.background
                = style.focused.background = style.onFocused.background = background;
            style.hover.background = style.onHover.background = hoverBackground;
            style.active.background = style.onActive.background = pressBackground;
            return style;
        }

        /// <summary>
        /// Sets the clipping of the style
        /// </summary>
        ...
        /// <summary>
        /// Sets the fixedWidth of the style
        /// </summary>
        ...
        /// </summary>
        public static GUIStyle Height(this GUIStyle style, float height)
        {
