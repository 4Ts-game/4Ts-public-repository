...
boardPattern( [ column(1, '018',
		...
		column(4, '',
		       '', '', '', '',
		       '', '', '', '') ]).
/* Role Play #4a ftf+online+online */
boardPattern( [ column(1, '018',
		       '111', '203', '310', '',
		       '102', '201', '306', ''),
		column(2, '019',
		...
		column(4, '',
		       '', '', '', '',
		       '', '', '', '') ]).
/* Role Play #5a ftf+ftf(writing text)+ftf*/
boardPattern( [ column(1, '018',
		       '111', '203', '310', '',
		       '102', '201', '306', ''),
		column(2, '019',
		...
		column(4, '',
		       '', '', '', '',
		       '', '', '', '') ]).
/* Role Play #6a ftf+online+online*/
boardPattern( [ column(1, '018',
		       '111', '203', '310', '',
		       '102', '201', '306', ''),
		column(2, '019',
...
boardPattern( [ column(1, '018',
		...
		column(4, '',
		       '', '', '', '',
		       '', '', '', '') ]).
/* Role Play #2b online+ftf+online */
boardPattern( [ column(1, '018',
		       '111', '203', '305', '',
		       '102', '201', '306', ''),
		column(2, '019',
		...
		column(4, '',
		       '', '', '', '',
		       '', '', '', '') ]).
/* Role Play #3b online+online+ftf */
boardPattern( [ column(1, '018',
		       '111', '203', '305', '',
		       '102', '201', '306', ''),
		column(2, '019',
		...
		column(4, '',
		       '', '', '', '',
		       '', '', '', '') ]).
/* Role Play #4b online+online+online */
boardPattern( [ column(1, '018',
		       '111', '203', '305', '',
		       '102', '201', '306', ''),
		column(2, '019',
		...
		column(4, '',
		       '', '', '', '',
		       '', '', '', '') ]).
/* Role Play #5b online+ftf(writing text)+ftf*/
boardPattern( [ column(1, '018',
		       '111', '203', '305', '',
		       '102', '201', '306', ''),
		column(2, '019',
		...
		column(4, '',
		       '', '', '', '',
		       '', '', '', '') ]).
/* Role Play #6b online+online+online*/
boardPattern( [ column(1, '018',
		       '111', '203', '305', '',
		       '102', '201', '306', ''),
		column(2, '019',
